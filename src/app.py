...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practice, drills and inter-school matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Skill development, scrimmages and tournaments",
    ...
    "Math Club": {
        "description": "Problem solving, math contests, and enrichment sessions",
